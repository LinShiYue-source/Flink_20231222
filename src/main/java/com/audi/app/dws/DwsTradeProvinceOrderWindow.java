...
import com.audi.bean.TradeProvinceOrderWindow;
...
public class DwsTradeProvinceOrderWindow {
    public static void main(String[] args) throws Exception {
        ...
        reduceWithProvinceDS.addSink(ClickHouseUtil.getJdbcSink("insert into dws_trade_province_order_window values(?,?,?,?,?,?,?)"));
