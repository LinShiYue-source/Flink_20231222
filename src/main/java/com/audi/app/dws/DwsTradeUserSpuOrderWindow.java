...
import com.audi.bean.TradeUserSpuOrderBean;
...
//        });
        ...
        reduceWithCategory1DS.addSink(ClickHouseUtil.getJdbcSink("insert into dws_trade_user_spu_order_window values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"));
