...
import com.audi.app.fun.DimAsyncFunction;
import com.audi.bean.TradeTrademarkCategoryUserRefundBean;
...
public class DwsTradeTrademarkCategoryUserRefundWindow {
    public static void main(String[] args) throws Exception {
        ...
        reduceWith1DS.print(">>>>>>>>>>>>");
        reduceWith1DS.addSink(ClickHouseUtil.getJdbcSink("insert into dws_trade_trademark_category_user_refund_window values(?,?,?,?,?,?,?,?,?,?,?,?,?)"));
